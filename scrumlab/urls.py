...
urlpatterns = [
    ...
    path('recipe/modify/<int:id_>/', jedzonko_views.ModifyRecipe.as_view()),
    ...
    path('plan/<int:id_>/', jedzonko_views.PlanDetails.as_view(), name='plan_details'),
    path('contact/', jedzonko_views.Contact.as_view(), name='contact'),
    path('about/', jedzonko_views.About.as_view(), name='about'),
    path('plan/modify/<int:plan_id_>/', jedzonko_views.EditPlan.as_view(), name='edit_plan'),
]
